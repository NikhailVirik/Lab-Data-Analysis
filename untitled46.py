...
results = np.loadtxt(r'C:\Users\Nikhail\Downloads\B_LED_2.txt')
...
plt.title('Blue LED Wavelength Spectrum')
plt.xlim(4.05e-7,5.0e-7)
...
ig=[1.2e9,4.6e-7,np.std(repx2, ddof=1)]
