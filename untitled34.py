# -*- coding: utf-8 -*-
"""
Created on Sat Dec  9 22:35:54 2023
...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec  9 15:05:07 2023
...
def find_n(t1,t2,N,lamb):
    ...
    for i in range(0,len(t1)):
        print(t1[i],t2[i])
        p1= 2*N[i]*lamb*(1-((np.cos((t1[i]-t2[i])/2))**2))
        p1s.append(p1)
        p2=4*t*(((np.cos((t1[i]-t2[i])/2))**2)-1)
        p2s.append(p2)
        p3=(4*t*(((np.cos((t1[i]-t2[i])/2))**2)-1))-(N[i]*lamb)
        p3s.append(p3)
