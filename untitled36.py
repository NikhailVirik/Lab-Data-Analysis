# -*- coding: utf-8 -*-
"""
Created on Sun Dec  3 22:59:01 2023
...
results = np.loadtxt(r'C:\Users\Nikhail\Downloads\UV_3.txt')

# Describe the global calibration used
metres_per_microstep = 1.88994e-11 # metres
...
plt.title('Hg lamp, green filter spectrum')
plt.show()
